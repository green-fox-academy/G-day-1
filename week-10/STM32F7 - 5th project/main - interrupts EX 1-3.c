...
int main(void)
{
   ...
   // DASHBUTTON
	...
	dashbutton.Pin = GPIO_PIN_6;
	dashbutton.Pull = GPIO_PULLDOWN;
	dashbutton.Speed = GPIO_SPEED_FAST;
	/* Here is the trick: our mode is interrupt on rising edge */
	dashbutton.Mode = GPIO_MODE_IT_RISING;

	HAL_GPIO_Init(GPIOF, &dashbutton);
...
{
    HAL_GPIO_EXTI_IRQHandler(dashbutton.Pin);
}
